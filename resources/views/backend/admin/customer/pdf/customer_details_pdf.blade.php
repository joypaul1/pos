  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col col-sm-12 text-center">
        <h4 style="font-weight: bold"><u>CUSTOMER PAYMENT SUMMARY</u></h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table" style="padding-top: -15px;">
          <tbody>
            <tr>
              <td  width="100%">Customer Name : {{$customer_info->name}}</td>
            </tr>
            <tr>
              <td> Mobile No : {{$customer_info->mobile}}</td>
            </tr>
            <tr>
              <td width="100%">Address : {{$customer_info->address}}</td>
            </tr>
          </tbody>
        </table>
      </div><br/>
