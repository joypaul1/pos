                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right">{{ number_format(optional($item->product)->unit_price, 2)??'-' }}</td>
                                        <td style="text-align:right">{{ number_format(optional($item->product)->unit_price* $item->selling_qty, 2)??'-' }}</td>
                                    </tr>
                                    @empty
                                        ...
                                        <td class="col" colspan="7" rowspan="3">
                                            <div class="d-flex p-2">
                                                ...
                                                <h6
                                                    ...
                                                    "
                                                >
                                                {{ ucwords(numberTowords($invoice->invoice_details[0]->product->unit_price * $invoice->invoice_details[0]->selling_qty??'0' )) }} Only.
                                                </h6>
                                            </div>
                                        </td>
