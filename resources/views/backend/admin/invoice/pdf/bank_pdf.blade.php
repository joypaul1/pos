            ...
            <div style="min-width: 600px">
                ...
                <main>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            {{-- @dd($invoice->invoice_details[0]->product->unit_price); --}}
                            ...
                            <tr style="" aria-rowspan="">
                                ...
                                <td class="total">{{ number_format(optional($item->product)->unit_price, 2)??'-' }}</td>
                                <td class="total">{{ number_format(optional($item->product)->unit_price* $item->selling_qty, 2)??'-' }}</td>
                            </tr>
                            @empty
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="border-left: 0; border-bottom: 2px dotted gray"
                                    ...
                                    <h6 style="font-size: 25px;"> <span class="text-left">
                                            {{ ucwords(numberTowords($invoice->invoice_details[0]->product->unit_price * $invoice->invoice_details[0]->selling_qty??'0' )) }} Only.</span>
                                    </h6>
                                </td>
                                ...
                                <td class="text-right">{{ number_format($invoice->invoice_details[0]->product->unit_price * $invoice->invoice_details[0]->selling_qty??'0' , 2) }}</td>
                            </tr>
                            <tr>
