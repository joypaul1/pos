...
<html>
<head>
  <title>কাস্টমার ভিত্তিক ক্রেডিট এর তালিকা</title>
...
<body>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <p style="text-align: center;margin-bottom: 0px;font-weight: bold;font-size: 20px;"><u>কাস্টমার ভিত্তিক ক্রেডিট এর তালিকা</u></p>
      	<hr>
      </div>
      <div class="col-md-12">
        <table width="100%" style="padding-top: -15px;">
          <tbody>
            <tr>
              <td width="25%">
                <p style="font-size: 18px;border-bottom: 1px dotted #000;width: 100%">নাম : {{$allData['0']['customer']['name']}}</p>
              </td>
              <td width="25%">
                <p style="font-size: 18px;border-bottom: 1px dotted #000;width: 100%">মোবাইল : {{$allData['0']['customer']['mobile']}}</p>
              </td>
              <td width="50%">
                <p style="font-size: 18px;border-bottom: 1px dotted #000;width: 100%">ঠিকানা : {{$allData['0']['customer']['address']}}</p>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="table table-bordered table-striped dt-responsive nowrap" style="width: 100%">
            ...
            <tbody>
              ...
              <tr class="{{$payment->id}}">
                ...
                <td>{{round($payment->due_amount, 2)}} টাকা</td>
                @php
                  $grand_total += $payment->due_amount;
                @endphp
              </tr>
              @endforeach
              <tr>
