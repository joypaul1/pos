...
<html>
<head>
  <title>কাস্টমার ভিত্তিক পেইড এর তালিকা</title>
...
<body>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <p style="text-align: center;margin-bottom: 0px;font-weight: bold;font-size: 20px;"><u>কাস্টমার ভিত্তিক পেইড এর তালিকা</u></p>
      	<hr>
      </div>
      <div class="col-md-12">
        ...
        <table class="table table-bordered table-striped dt-responsive nowrap" style="width: 100%">
            ...
            <tbody>
              ...
              <tr class="{{$payment->id}}">
                ...
                <td>{{$payment->paid_amount}} টাকা</td>
                @php
