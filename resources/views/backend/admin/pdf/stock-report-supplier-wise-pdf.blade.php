...
<html>
<head>
  <title>সাপ্লায়ার ভিত্তিক স্টক রিপোর্ট</title>
...
<body>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <p style="text-align: center;margin-bottom: 0px;font-weight: bold;font-size: 20px;"><u>সাপ্লায়ার ভিত্তিক স্টক এর তালিকা ({{date('d-m-Y',strtotime($start_date))}} - {{date('d-m-Y',strtotime($end_date))}})</u></p>
      	<hr>
      </div>
      <div class="col-md-12">
        <p>সাপ্লায়ারের নাম : {{$supplier}}</p>
