                        ...
                        <div class="card-header">
                            <h5>{{(@$editData) ? ("Update Product") : "Add Product"}}
                                <a class="btn btn-sm btn-success float-right"
                                    href="{{route('products.product.view')}}"><i class="fa fa-list"></i> Product
                                    List</a>
                            </h5>
                        </div>
                        <div class="card-body">
                            <form method="post"
                                action="{{!empty($editData->id) ? route('products.product.update',$editData->id) : route('products.product.store')}}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="supplier_id" id="supplier_id" class="form-control">
                                            ...
                                            <option value="{{$supplier->id}}" {{(@$editData->
                                                supplier_id==$supplier->id)?"selected":""}}>{{$supplier->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="sheif_no" class="form-control"
                                            value="{{@$editData->sheif_no}}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Model Of vehicle</label>
                                        <input type="text" name="model_Of_vehicle" class="form-control"
                                            value="{{ @$editData->model_Of_vehicle }}"
                                            placeholder="Write model_Of_vehicle">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Class Of vehicle</label>
                                        <input type="text" name="class_Of_vehicle" class="form-control"
                                            value="{{ @$editData->class_Of_vehicle }}"
                                            placeholder="Write class_Of_vehicle">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="year_of_manufacture" class="form-control"
                                            ...
                                            placeholder="Write year_of_manufacture">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="description" class="form-control form-control-sm" id="size"
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Part Id </label>
                                        <input type="text" name="pid" class="form-control" value="{{@$editData->pid}}"
                                            placeholder="Write Part Id">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="pname" class="form-control"
                                            value="{{@$editData->pname}}" placeholder="Write Part Nam">
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label>Part Model </label>
                                        <input type="text" name="pmname" class="form-control"
                                            value="{{@$editData->pmname}}" placeholder="Write Part Modeld">
                                    </div>

                                    <br>
                                    <div class="form-group col-md-6" style="padding-top: 30px;">
                                        <button type="submit" class="btn btn-primary">{{(@$editData) ? 'Update' :
                                            'Submit'}}</button>
                                    </div>
                                </div>
                            </form>
