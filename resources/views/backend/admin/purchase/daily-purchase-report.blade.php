            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
						<h2 class="main-title float-left">Manage daily purchase report</h2>
						<ol class="breadcrumb float-right">
							<li class="breadcrumb-item">Home</li>
							<li class="breadcrumb-item">daily purchase</li>
						</ol>
            ...
            <div class="container fullbody">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<form method="POST" action="{{route('purchases.purchase.date.wise.pdf')}}" id="myForm" target="_blank">
								@csrf
								<div class="form-row">
									<div class="col-md-3">
...
<script type="text/javascript">
	$(document).on('click','#search',function(){
		...
		var end_date = $('#end_date').val();
		$.ajax({
			url: "{{route('purchases.purchase.date.wise.handlebar')}}",
			type: "get",
			data: {
